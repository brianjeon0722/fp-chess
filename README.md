...
# Instructions for running the code: Install the chess library, Openix library, and collections library. Run python3 fp_opening.py to play the easy version. Run python3 fp_lines.py to play the hard version. No need for any other API keys or hosting.
